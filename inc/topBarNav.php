    ...
    <div class="d-flex justify-content-between w-100">
        ...
        <div>
            ...
            <span class="mx-2">Howdy,
                <?= !empty($_settings->userdata('email')) ? $_settings->userdata('email') : $_settings->userdata('username') ?></span>
            ...
            <!-- <a href="./register.php" class="mx-2 text-light me-2">Register</a>
              <a href="./login.php" class="mx-2 text-light me-2">Student</a>
              <a href="./admin" class="mx-2 text-light me-2">Admin</a> -->
            <a href="./logins.php" class="mx-2 text-light me-2">Login</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
<nav class="main-header navbar navbar-expand navbar-light border-0 navbar-light text-sm" id='top-Nav'>
    ...
    <div class="container">
        <a href="./" class="navbar-brand">
            ...
            <span style="color:maroon;font-weight:bold;font-size: 1.10rem"><?= $_settings->info('short_name') ?></span>
        </a>
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <?php if($_settings->userdata('id') > 0 and $_settings->userdata('type') != 1): ?>
            <li class="nav-item">
                <a href="./?page=profile"
